...
fn piecewise_fit_segment_selection_and_positions_match_oracle_fixture() {
    ...
    const POSITION_BITS: [[u64; 3]; 4] = [
        [0xc171bba82632534a, 0xc1425cc7fe82dee7, 0x4171ccd202c5ad1a],
        [0xc1715102ae7dda40, 0xc172c5ff1e2b02da, 0x4145a09e7e63f9e9],
        [0x41340d617d132160, 0xc172959829f423d5, 0xc171e72b84cc2cb2],
        [0x416cdd54f4e8b80d, 0xc153c12ec861135d, 0xc17487514877aa19],
    ];
