"""Write RTCM 3 frames of the network RTK and transformation messages from
pyrtcm's message layouts, as a reference independent of sidereon's codec.

For each of 1014-1017, 1021-1027, 1030-1032, 1034, 1035 and 1037-1039 this
...
def main():
    ...
    for repeat in range(4):
        for number in MESSAGES:
            ...
            assert len(read_back) == len(entries), number
            for (name, raw), (attr, value) in zip(entries, read_back):
